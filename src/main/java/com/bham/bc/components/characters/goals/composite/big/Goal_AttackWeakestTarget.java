...
import static com.bham.bc.components.characters.goals.GoalTypes.goal_attack_weakest_target;


public class Goal_AttackWeakestTarget extends Goal_Composite {

    public Goal_AttackWeakestTarget(GameCharacter pOwner) {
        super(pOwner, goal_attack_weakest_target);
    }
    ...
    public void activate() {
        ...
        agent.getTargetingSystem().setTargetEvaluator(new TargetingPolices.HealthEvaluator());
