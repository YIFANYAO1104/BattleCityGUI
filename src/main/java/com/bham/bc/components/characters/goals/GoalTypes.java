 ...
 */
package com.bham.bc.components.characters.goals;
...
public class GoalTypes {
    ...
    public static final int goal_get_weapon = 8;
    ...
    public static final int goal_wait_for_path = 18;
    public static final int goal_until_could_pass = 19;
