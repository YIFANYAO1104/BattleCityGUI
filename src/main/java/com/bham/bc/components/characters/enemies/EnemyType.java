...
public enum EnemyType {
     ...
     * @return a new instance of a specific child class of {@link Enemy} object
     *
     ...
     */
    public Enemy newInstance(double x, double y) throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InstantiationException, InvocationTargetException {
        ...
        try {
            ...
            return (Enemy) cons.newInstance(x, y);
