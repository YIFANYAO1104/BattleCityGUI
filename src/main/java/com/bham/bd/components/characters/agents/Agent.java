package com.bham.bd.components.characters.agents;
...
import com.bham.bd.entity.ai.behavior.StateMachine;
...
public abstract class Agent extends GameCharacter {
     ...
     */
    protected Agent(double x, double y, double speed, double hp,Side side) {
