...
import com.bham.bd.components.triggers.effects.HitMarker;
import com.bham.bd.components.triggers.effects.RingExplosion;
import com.bham.bd.entity.BaseGameEntity;
import com.bham.bd.entity.ai.director.Director;
...
public abstract class Controller extends BaseGameEntity implements Services {
    ...
    /**
     * Constructs center controller as a {@link com.bham.bd.entity.BaseGameEntity} object
     */
    public Controller() {
